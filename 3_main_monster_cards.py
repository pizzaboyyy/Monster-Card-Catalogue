                ...
                if new_values:
                    ...
                    try:
                        ...
                        # error messages
                            ...
                            easygui.msgbox("Attributes must be between 1 and 25\n"
                                           " No Changes Were Made", "Error")
                    except ValueError:
                        easygui.msgbox("Invalid input. Attributes must be numbers\n"
                                       " No Changes Were Made", "Error")
                else:
...
view_instructions = easygui.ynbox("Hello! Welcome to The Monster Card Catalogue Program!\n"
                                  "          -- Do You Want To View The Instructions First? --", "Instructions",
                                  choices=["Yes", "No"])
